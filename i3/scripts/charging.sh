...
case "$BATTERY_STATE" in
	0) BATTERY_CHARGING="Discharging" ; BATTERY_ICON="discharging" ;;
	1) BATTERY_CHARGING="Charging" ; BATTERY_ICON="charging" ;;
esac

# Send notification
dunstify -a "charging" "${BATTERY_CHARGING}" "${BATTERY_LEVEL}% of battery charged." -u normal -i "$HOME/.config/i3/scripts/assets/battery-${BATTERY_ICON}.png" -t 5000 -r 9991